package com.apemans.tuyahome.component.ui.main
...
import com.apemans.tuyahome.component.databinding.LayoutBottomTabBinding
import com.apemans.tuyahome.component.databinding.TuyahomeActivityMainBinding
...
class MainActivity : BaseComponentActivity<TuyahomeActivityMainBinding>() {

    private val titleList = listOf(R.string.home, R.string.camera, R.string.camera, R.string.mine)
    private val iconList = listOf(R.drawable.ic_menu_home_selector, R.drawable.ic_menu_ipc_selector, R.drawable.ic_menu_ipc_selector, R.drawable.ic_menu_account_selector)
