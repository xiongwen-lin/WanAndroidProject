package com.apemans.smartipcimpl.ui.ipcdevices.player.com.hdl.ruler;
...
import com.apemans.smartipcimpl.ui.ipcdevices.player.com.hdl.ruler.bean.OnSelectedTimeListener;
import com.apemans.smartipcimpl.ui.ipcdevices.player.com.hdl.ruler.bean.ScaleMode;
import com.apemans.smartipcimpl.ui.ipcdevices.player.com.hdl.ruler.bean.TimeSlot;
import com.apemans.smartipcimpl.ui.ipcdevices.player.com.hdl.ruler.utils.CUtils;
...
//    private final int ONEDAY_TIME = 24 * 60 * 60 * 1000;
     ...
     * 滑动结果回调
     */
    private OnBarMoveListenerIPC onBarMoveListener;
    /**
     * 线性布局
     */
     ...
     * 滑动条默认高度，以前是176
     */
    private int viewHeight = CUtils.dip2px(58);
    /**
     * 屏幕的宽度
     */
    ...
    private int centerLineColor = 0xffffffff;//中轴线画笔颜色
...
//                                    //实时地将结果回调出去
     ...
     * @param vedioTimeSlot
     */
    public void setVedioTimeSlot(ArrayList<TimeSlot> vedioTimeSlot) {
...
//                        ELog.e("当前时间：" + DateUtils.getDateTime(currentTimeMillis));
    ...
    /**
     * 画中间线,
     * startX TODO 注意，项目有个关闭按钮50dp
     * @param canvas
     */
    private void drawCenterLine(Canvas canvas) {
         int startX = (getWidth()+ CUtils.dip2px(50)) / 2;
        canvas.drawLine(startX, 0, startX, viewHeight , centerLinePaint);
    }
     ...
     */
    public void setOnBarMoveListener(OnBarMoveListenerIPC onBarMoveListener) {
