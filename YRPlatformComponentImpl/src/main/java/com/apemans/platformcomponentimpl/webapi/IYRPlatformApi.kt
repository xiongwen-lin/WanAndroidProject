package com.apemans.platformcomponentimpl.webapi
...
interface IYRPlatformApi {
    ...
    @GET(YRPlatformApiConstant.API_PATH_OF_FETCH_CLOUD_VIDEO_LIST)
    ...
    @Headers(HEADER_BASE_URL_NAME_OF_S3, HEADER_API_SIGN_TYPE_SECRET)
    @GET(YRPlatformApiConstant.API_PATH_OF_FETCH_DOORBELL_CLOUD_VIDEO_LIST)
