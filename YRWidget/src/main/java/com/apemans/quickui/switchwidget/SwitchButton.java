package com.apemans.quickui.switchwidget;
...
public class SwitchButton extends View implements Checkable {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        isClickAutoSwitch = optBoolean(typedArray,R.styleable.SwitchButton_sb_click_auto_switch,true);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (!isClickAutoSwitch){
            if (MotionEvent.ACTION_DOWN == actionMasked){
                touchDownTime = System.currentTimeMillis();
                if (touchDownTime - mLastClickTime <= timeInterval){
                    return true;
                }else {
                    mLastClickTime = touchDownTime;
                    if (onClickChangeListener != null){
                        onClickChangeListener.onClickChanged(this,isChecked());
                    }
                    return true;
                }
            }
    ...
    public void setOnClickChangeListener(OnClickChangeListener l) {
        onClickChangeListener = l;
    }

    public interface OnClickChangeListener {
        void onClickChanged(SwitchButton view, boolean isChecked);
    }
    ...
    private boolean isClickAutoSwitch = false;
