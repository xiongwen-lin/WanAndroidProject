package com.apemans.quickui.progress
...
import com.apemans.quickui.dp2px
import com.apemans.quickui.sp2px
...
class CircleProgressView @JvmOverloads constructor(
    ...
    private var mReachBarSize = context.dp2px(2f) // 未完成进度条大小
    private var mNormalBarSize = context.dp2px(2f) // 未完成进度条大小
    private var mReachBarColor = Color.parseColor("#108ee9") // 已完成进度颜色
    private var mNormalBarColor = Color.parseColor("#FFD3D6DA") // 未完成进度颜色
    private var mTextSize = context.sp2px(14f) // 进度值字体大小
    ...
    private var mRadius = context.dp2px(20f) // 半径
    ...
    private var mInnerPadding = context.dp2px(1f) // 内部圆与外部圆间距
    ...
    private var rectInner // 内部圆环绘制区域
            : RectF? = null
    private var mOuterSize = context.dp2px(1f) // 外层圆环宽度
