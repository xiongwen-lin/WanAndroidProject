package com.apemans.usercomponent.easypermissions;
    ...
    public static class Builder {
        ...
        public AppSettingsDialog build() {
            mRationale = TextUtils.isEmpty(mRationale) ?
                    /*mContext.getString(R.string.rationale_ask_again)*/"This app may not work correctly without the requested permissions.\n" +
                    "        Open the app settings screen to modify app permissions." : mRationale;
            mTitle = TextUtils.isEmpty(mTitle) ?
                    /*mContext.getString(R.string.title_settings_dialog)*/"Permissions Required" : mTitle;
