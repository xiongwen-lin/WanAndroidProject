...
import com.apemans.usercomponent.easypermissions.helper.PermissionHelper;
...
public final class PermissionRequest {
    ...
    public static final class Builder {
         ...
         * permanently deny your permissions, use the  instead.
         * <p>
        ...
        public PermissionRequest build() {
            if (mRationale == null) {
                mRationale = "This app may not work correctly without the requested permissions."/*mHelper.getContext().getString(R.string.rationale_ask)*/;
            }
