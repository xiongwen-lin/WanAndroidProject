...
//    public static final String URL_PRIVACY_POLICY = "http://osaio.net/privacy-policy-%s";
//    public static final String URL_TERMS = "http://osaio.net/terms-%s";
//    public static final String URL_PRIVACY_POLICY_TEMPLATE = "http://osaio.net/privacy-policy-%s-%s";
    ...
    public static final String SMART_STRIP_TWO = "SS31/SS42";//teckin防水排插
    public static final String SMART_STRIP_THREE = "SS33";//teckin防水排插
    public static final String SMART_STRIP_FIVE = "SS32";//teckin防水排插
    public static final String SMART_STRIP_SIX = "SS34";//teckin防水排插
    public static final String SMART_STRIP_FOUR = "SS30N";//teckin排插
